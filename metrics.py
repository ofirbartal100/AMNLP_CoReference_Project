...
class CorefEvaluator(object):
    ...
    def get_f1_all(self):
        return {e.metric : e.get_f1() for e in self.evaluators}

    def get_recall_all(self):
        return {e.metric : e.get_recall() for e in self.evaluators}

    def get_precision_all(self):
        return {e.metric : e.get_precision() for e in self.evaluators}

    def get_prf_all(self):
        return self.get_precision_all(), self.get_recall_all(), self.get_f1_all()
