...
def minimize_language(data_dir, language, labels, stats):
    minimize_partition(data_dir, "dev", language, "no", labels, stats)
    minimize_partition(data_dir, "train", language, "no", labels, stats)
    minimize_partition(data_dir, "test", language, "no", labels, stats)
